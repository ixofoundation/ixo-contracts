...
pub enum Cw1155QueryMsg {
    ...
    /// Returns the current balance of all addresses for a specific batch of tokens, 0 if unset.
    #[returns(BatchBalanceResponse)]
    BatchBalanceForTokens { token_ids: Vec<TokenId> },
    /// Returns the current balance of all addresses for a batch of all tokens, 0 if unset.
    #[returns(BatchBalanceForAllResponse)]
    BatchBalanceForAll {},
...
#[cw_serde]
pub struct BatchBalanceForAllResponse {
    pub balances: Vec<TokenInfo>,
}
